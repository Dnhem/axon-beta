...
tricep_extension = Exercise(name="cable tricep extension", sets="3", rest="0:15", client_id=2, date="2022-09-15")
bicep_curl = Exercise(name="dumbbell bicep curl", sets="2", rest="0:25", client_id=2, date="2022-09-15")
kb_row = Exercise(name="kettle bell row", sets="4", rest="0:35", client_id=2, date="2022-09-15")
assault_bike = Exercise(name="assault bike", sets="3", rest="0:15", duration="0:45", client_id=2, date="2022-09-15")
