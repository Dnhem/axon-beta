...
bench_push_ups = Exercise(
    name="bench push-ups", sets="3", reps="6", rest="30", client_id=2, date="2022-09-12"
)
banded_glute_bridge = Exercise(
...
tricep_extension = Exercise(
    name="cable tricep extension", sets="3", rest="0:15", client_id=2, date="2022-09-15"
)
bicep_curl = Exercise(
    name="dumbbell bicep curl", sets="2", rest="0:25", client_id=2, date="2022-09-15"
)
kb_row = Exercise(
    name="kettle bell row", sets="4", rest="0:35", client_id=2, date="2022-09-15"
)
assault_bike = Exercise(
    name="assault bike",
    sets="3",
    rest="0:15",
    duration="0:45",
...
db.session.add(tricep_extension)
db.session.add(bicep_curl)
db.session.add(kb_row)
db.session.add(assault_bike)
db.session.commit()
